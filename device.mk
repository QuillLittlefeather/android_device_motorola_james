...
# Camera
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/camera/msm8917_mot_james_camera.xml:system/etc/camera/msm8917_mot_james_camera.xml \
...
# Thermal
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/thermal-engine-james.conf:system/etc/thermal-engine-james.conf
